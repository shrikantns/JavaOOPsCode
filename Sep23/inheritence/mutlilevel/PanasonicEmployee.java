...
class Developer extends PanasonicEmployee {
    ...
    public void writeCode() {
        // Custom method for managing projects
        System.out.println("Manager " + getName() + " is writing code in " +getProgrammingLanguage());
    }
}

class Programmer extends PanasonicEmployee {
    ...
    public void debugCode() {
        ...
        System.out.println("Programmer " + getName() + " is debugging code in " +getJobtitle());
    }
    ...
    public static void main(String[] args) {
        ...
        Programmer programmer = new Programmer("Yaron Gabriel", "3 ABC St", 76000.0, "Programmer");
